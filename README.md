--// ============================================================================
--// RYU HUB - MODERN GLASS EDITION (FLAWLESS ACCORDION & RESPONSIVE SCALING)
--// ============================================================================
...
local Theme = {
    Background    = Color3.fromRGB(5, 7, 12),          -- Deep Obsidian Dark
    BgTransp      = 0.35,                              -- Perfektes Glassmorphism
    Sidebar       = Color3.fromRGB(10, 14, 22),
    SectionBG     = Color3.fromRGB(15, 20, 30),
    SectionTransp = 0.4,
    
    CardBorder    = Color3.fromRGB(40, 60, 80),        -- Subtiler Rahmen
    TextPrimary   = Color3.fromRGB(255, 255, 255),     -- Crisp White
    TextSecondary = Color3.fromRGB(150, 170, 190),     -- Muted Blue-Grey
    
    Accent        = Color3.fromRGB(0, 229, 255),       -- Neon Cyan (RyuHub Signature)
    AccentGlow    = Color3.fromRGB(120, 245, 255),
    ToggleOff     = Color3.fromRGB(25, 30, 45),
    CloseRed      = Color3.fromRGB(255, 59, 48),       -- Modernes Rot für das X
...
function CreateMainTab(tabName, icon)
    ...
    -- Main Wrapper für flüssiges Tweening
    ...
    tabBtn.Activated:Connect(function()
        ...
        -- Öffne diesen Tab, falls er vorher zu war
        if not wasOpen then
            tabObj.IsOpen = true
    ...
    function tabObj:CreateSubTab(subName)
        ...
        subBtn.Size = UDim2.new(0.9, 0, 0, 30) -- Leicht eingerückt
...
--// ============================================================================
--// GUI INITIALIZATION (EXAMPLE SETUP)
--// ============================================================================

-- Main
local TabMain = CreateMainTab("Main", "🏠")
local SubGeneral = TabMain:CreateSubTab("General Setup")
local SecGeneral = CreateSection(SubGeneral, "Player Settings")
CreateToggle(SecGeneral, "Enable Advanced Features", false, function() end)

-- Impel Down
local TabImpel = CreateMainTab("Impel Down", "⚔️")
